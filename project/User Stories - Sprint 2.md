...
- Status: [ ] Pending
- Tags: —
- Data Contract Touched: — (tokens stored locally, not in Dexie tables unless a minimal settings store is added)
...
- Test Notes:
  - Token expiry/refresh; error cases; iOS/Android/desktop.
