...
const clientSchema = z.object({
    ...
    NEXT_PUBLIC_STRIPE_PRICE_ID_YEARLY_PROMO: z.string().optional(),
...
const processEnv = {
    ...
    NEXT_PUBLIC_STRIPE_PRICE_ID_YEARLY_PROMO: process.env.NEXT_PUBLIC_STRIPE_PRICE_ID_YEARLY_PROMO,
