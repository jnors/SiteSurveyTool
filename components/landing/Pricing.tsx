...
export function Pricing() {
    ...
    const getPriceDisplay = () => {
        switch (billingCycle) {
            case 'monthly': return { amount: '€10', period: '/mo' }
            case 'yearly': return { amount: '€96', period: '/yr' }
            case 'promo': return { amount: '€60', period: '/yr' }
        }
    }

    const { amount, period } = getPriceDisplay()
            ...
            <div className="container px-4 md:px-6 mx-auto">
                    ...
                    <div className="mt-6">
                        <Tabs value={billingCycle} onValueChange={(v) => setBillingCycle(v as any)} className="w-auto">
                            <TabsList className="grid w-full grid-cols-3">
                                ...
                                <TabsTrigger value="promo" className="relative font-semibold text-primary">
                                    Special
                ...
                <div className="grid grid-cols-1 gap-6 mt-12 md:grid-cols-2 md:gap-8 max-w-4xl mx-auto">
                    ...
                    <div className="flex flex-col p-6 bg-background rounded-xl border-2 border-primary shadow-lg relative overflow-hidden">
                        ...
                        <div className="mt-4 flex items-baseline text-3xl font-bold">
                            {amount}
                            <span className="ml-1 text-xl font-normal text-muted-foreground">{period}</span>
                        </div>
                        <ul className="mt-6 space-y-3 flex-1">
                            <li className="flex items-center gap-2">
